...
- See the **[MicroPython Configuration Guide](../../micropython/README.md#quick-start)**.
...
- See the **[Config.xml Reference](../technical/config-xml.md)** for details on the standard schema.
